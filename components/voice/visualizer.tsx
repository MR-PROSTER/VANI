...
const Visualizer = ({ showButton }: { showButton: boolean }) => {
    ...
    }, [cancelAnimation, setIsRecording]);
    ...
    const drawVisualizer = useCallback(() => {
        ...
        dataRef.current = dataRef.current || new Uint8Array(bufferLength);
    ...
    const startRecording = useCallback(async () => {
        try {
            ...
            // 4. Connect source → analyser (ORDER MATTERS!)
            ...
            mediaRecorder.start(3000)  // 3 seconds chunks for Sarvam
    ...
    }, [drawVisualizer, setIsRecording, setSessionReady])
